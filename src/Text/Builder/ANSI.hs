...
import qualified Data.Text.Internal.Builder as Lazy.Builder
import qualified Data.Text.Lazy.Builder.Int as Lazy.Builder
...
rgb r g b =
    foreground (Builder.fromString "38;2;" <> decimal r <> semi <> decimal g <> semi <> decimal b)
{-# INLINE rgb #-}
...
rgbBg r g b =
    background (Builder.fromString "48;2;" <> decimal r <> semi <> decimal g <> semi <> decimal b)
{-# INLINE rgbBg #-}
...
decimal :: Word8 -> Builder
decimal =
    Builder.fromLazyText . Lazy.Builder.toLazyText . Lazy.Builder.decimal
